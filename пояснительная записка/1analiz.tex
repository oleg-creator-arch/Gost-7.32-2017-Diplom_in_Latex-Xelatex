...
САО РАН имеет иерархический тип структуры управления с линейно-штабной организационной структурой. Условно можно выделить 5 объектов, представим их  на рисунке \ref{pic:commpa}
\addimghere{resources/org}{1}{Организация структуры на примере диаграммы компонентов}{pic:commpa}
